...
| プロフィール | `/profile` | ユーザー情報表示・編集 | Phase 5 |
...
- [x] ポート番号とは何かを説明できる
- [x] GET、POST、DELETEの違いを説明できる
- [x] 200、400、404、500の意味を説明できる
- [x] リクエストヘッダーとボディの違いを説明できる
- [x] DevToolsの各タブの役割を説明できる
- [x] DNSの役割を説明できる
